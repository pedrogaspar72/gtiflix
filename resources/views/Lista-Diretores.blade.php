                ...
                <div class="group flex flex-col h-full bg-white border border-gray-500 shadow-2xs rounded-xl">
                    ...
                    <div class="p-4 md:p-6">
                        ...
                        <p class="mt-3 text-gray-500 dark:text-neutral-500">
                            {{$diretor->nacionalidade ?? 'Nacionalidade não informada'}}
                        </p>
                        @if($diretor->data_nascimento)
                            <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">
                                Nascimento: {{ \Carbon\Carbon::parse($diretor->data_nascimento)->format('d/m/Y') }}
                            </p>
                        @endif
                    </div>
                    <!-- REMOVIDO: A parte do botão "Ver detalhes" foi removida -->
                </div>
                <!-- End Card -->
            @endforeach
